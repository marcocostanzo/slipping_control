...
void combineStatic()
{
  ...
  out_msg.sigma = (in_msg0.sigma);

  out_msg.cor_tilde = (in_msg0.cor_tilde);

  out_msg.cor = (in_msg0.cor);

  out_msg.ft_tilde_ls = (in_msg0.ft_tilde_ls);

  out_msg.taun_tilde_ls = (in_msg0.taun_tilde_ls);

  out_msg.ft_ls = in_msg0.ft_ls;

  out_msg.taun_ls = in_msg0.taun_ls;

  out_msg.radius = (in_msg0.radius);

  out_msg.generalized_max_force = in_msg0.generalized_max_force;

  out_msg.generalized_max_force0 = in_msg0.generalized_max_force;

  out_msg.generalized_max_force1 = 0;

  out_msg.generalized_force = in_msg0.generalized_force;

  out_msg.generalized_force0 = in_msg0.generalized_force;

  out_msg.generalized_force1 = 0;

  out_msg.fn_ls = fn_ls_gain * (in_msg0.fn_ls);

  out_msg.fn_ls_free_pivot = in_msg0.fn_ls_free_pivot;

  out_msg.is_inside_ls0 = in_msg0.is_inside_ls;

  out_msg.is_inside_ls1 = 0;

  out_msg.is_inside_ls = in_msg0.is_inside_ls;
